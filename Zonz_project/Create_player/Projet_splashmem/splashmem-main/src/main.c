...
#define NB_LIB_PROG 3

int          quitting      = 0;
SDL_Window*  window        = NULL;
SDL_Surface* screenSurface = NULL;
static uint8_t action_joueur_1[MAX_DIGITS], game_mode[2]; // Tableaux pour stocker les chiffres
...
int main(int argc, char* argv[])
{
    ...
    window = SDL_CreateWindow("SplashMem", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1000,
...
void action_joueur(uint8_t** action_tab_j1, uint16_t* nombre_act_j1)
{
